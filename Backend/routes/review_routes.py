...
from controllers.review_controller import submit_review, get_product_reviews, get_my_reviews, get_farmer_reviews
...
review_bp.route('/farmer', methods=['GET'])(jwt_required()(get_farmer_reviews))
